...
test("title of specified task should be changed", () => {
  const endState = tasksReducer(startState, changeTaskTitleAC("2", "#yogurt", "todolistId2", "yogurt"));

  expect(endState["todolistId1"][1].title).toBe("JS");
  expect(endState["todolistId2"][1].title).toBe("#yogurt");
  expect(endState["todolistId2"][1].tag).toBe("yogurt");
  expect(endState["todolistId2"][0].title).toBe("bread");
  expect(endState["todolistId2"][0].tag).toBe("");
  console.log(endState["todolistId2"][1].tag);
});
